...
class Application(ttk.Frame):
    ...
    def __init__(self):
        ...
        self.style.configure('TButton', font=('Arial', 12,"bold"), foreground='white', background='black')
        self.style.configure('TLabel', font=('Arial', 11), foreground='black', background='white')
        self.style.configure('TFrame', foreground='white', background='white')
        self.style.configure('TEntry', font=('Arial', 11), background='white')
    ...
    def updateAccount(self, acc):
        ...
        self.add_account_button.destroy()
        self.label.pack_forget()
        self.label.pack(side='top', padx=10, pady=3)
        self.tv.place(relx=0.5, rely=0.5, anchor='center', width=600, height=450)
    ...
    def _createWidgets(self):
        # self._createAppMenu()
        self.label = ttk.Label(self, text="Welcome to pjsua2 Demo",style='TLabel')
        self.label.pack(side='top', padx=10, pady=10)

        self.add_account_button = ttk.Button(self, text="Add Account", style="TButton", command=self._onMenuAddAccount)
        self.add_account_button.place(relx=0.5, rely=0.5, anchor='center')
        self.window_menu = tk.Menu(self, tearoff=False)
        # Main pane, a Treeview
        self.tv = ttk.Treeview(self, columns=('Status'))
        self.tv.heading('Status', text='Status')
        self.tv.column('Status', width=100)
